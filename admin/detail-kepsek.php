            ...
            <div class="col-md-10 col-sm-10 mb-3">
                <div class="card-body">
                    <table class="table table-borderless" align="center">
                        <tbody>
                            <?php $ks = $kepsek->detail_kepsek($_GET['id_kepsek']); ?>
                            ...
                            <tr>
                                <td class="text-left" colspan="3">
                                    <a href="koneksi.php?delete_kepsek=<?= $row['id_kepsek'] ?>"  onclick="return confirm('Yakin akan menghapus?')" class="btn btn-outline-danger"><i class="fa fa-trash"></i> Hapus</a>
                                    <a href="data-kepsek.php" class="btn btn-outline-dark"> Kembali</a>
                                </td>
                            </tr>
                            <?php endforeach; ?>
                        </tbody>
