<?php 
    ...
    $kepsek = query("SELECT * FROM data_kepsek");
 ?>
                            ...
                            <table class="table table-borderless" align="center">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><?= $kepsek["nip"];?></td>
                                        <td rowspan="4"><img width="200" height="200" src="<?= $kepsek["foto"] ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Lengkap</td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td class="text-left" colspan="3">
                                            <a href="data-kepsek.php" class="btn btn-outline-dark" name="kembali"> Kembali</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
