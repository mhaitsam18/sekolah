<?php 
    ...
    $guru = query("SELECT * FROM data_guru WHERE id_guru = $id_guru");
 ?>
                            ...
                            <table class="table table-borderless" align="center">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><?= $guru["nip"];?></td>
                                        <td rowspan="4"><img width="200" height="200" src="<?= $guru["foto"] ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Lengkap</td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td class="text-left" colspan="3">
                                            <a href="data-guru.php" class="btn btn-outline-dark" name="kembali"> Kembali</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
