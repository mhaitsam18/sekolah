<?php 
    ...
    $siswa = query("SELECT * FROM data_kelas1 WHERE id_siswa = $id_siswa");
 ?>
        ...
        <div id="content-wrapper" class="d-flex flex-column">
            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <!-- Page Heading -->
                    <h1 class="h3 mb-2 text-gray-800">Detail Data Siswa Kelas 1</h1>
                            ...
                            <table class="table table-borderless" align="center">
                                <tbody>
                                    ...
                                    <tr>
                                        ...
                                        <td>:</td>
                                        <td><?= $siswa["nis"];?></td>
                                        <td rowspan="4"><img width="200" height="200" src="<?= $siswa["foto"] ?>"></td>
                                    </tr>
                                    <tr>
                                        <td>Nama Lengkap</td>
                                        <td>:</td>
                                    ...
                                    <tr>
                                        <td class="text-left" colspan="3">
                                            <a href="data-kelas1.php" class="btn btn-outline-dark" name="kembali"> Kembali</a>
                                        </td>
                                    </tr>
                                </tbody>
                            </table>
