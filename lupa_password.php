            ...
            <div class="col-lg-5">
                <div class="card shadow-lg border-0 rounded-lg mt-5">
                    <div class="card-body">
                        ...
                        <form method="post" action="koneksi/Admin.php?cek_username_nip">
                            <div class="form-group">
                                <label class="small mb-1" for="inputUsername">Username/Email</label>
                            ...
                            <div class="form-group">
                                ...
                                <div class="input-group">
	                                ...
	                                <input class="form-control py-4" id="inputNip" type="number"name="nip" placeholder="Masukkan NIP anda" />
	                            </div>
                            </div>
                            <!-- <div class="form-group">
