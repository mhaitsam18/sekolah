                ...
                <div class="card border-left-danger shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            ...
                            <div class="col-auto">
                                <span class="pull-right"><i class="fas fa-users fa-2x text-gray-300"></i></span>
                            </div>
                        </div>
                    </div>
            ...
            <div class="col-xl-3 col-md-6 mb-4">
                <div class="card border-left-info shadow h-100 py-2">
                    <div class="card-body">
                        <div class="row no-gutters align-items-center">
                            <div class="col mr-2">
                                <div class="text-xs font-weight-bold text-info text-uppercase mb-1">Kepala Sekolah</div>
                                <div class="h5 mb-0 font-weight-bold text-gray-800"><?= $jumlahKepsek ?></div>
                            </div>
                            <div class="col-auto">
                                <i class="fas fa-users fa-2x text-gray-300"></i>
                            </div>
                    ...
                    <div class="card-footer">
                        <a href="data-kepsek.php" class="card-link text-dark">Lihat <i class="fas fa-chevron-circle-right"></i></a>
                    </div>
                </div>
            </div>
