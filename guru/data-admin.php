                        ...
                        <div class="card-body">
                            <div class="table-responsive">
                                <table class="table table-bordered table-hover table-sm" id="dataTable" width="100%" cellspacing="0">
                                    ...
                                    <?php if(empty($admin)) : ?>
                                    <tr>
                                        <td colspan="4" align="center"><p style="color: red; font-style: italic;">data tidak ditemukan!</p></td>
                                    </tr>
                                    <?php endif; ?>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td class="text-center">
                                                <a href="detail-admin.php?id_admin=<?= $row["id_admin"]; ?>" class=""><i class="fas fa-eye"></i></a>
                                            </td>
                                        </tr>
                                        <?php $i++; ?>
                                        <?php endforeach; ?>
