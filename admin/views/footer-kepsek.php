        ...
        <div class="modal-body">
            <div class="card-body">
                <form method="post" action="" enctype="multipart/form-data">
                    <div>
                        <input type="file" name="foto" class="form-control"  placeholder="Masukkan foto" required>
                    </div><br>
                    <div>
                        <input type="text" name="nip" class="form-control"  placeholder="Masukkan NIP" required autocomplete="off">
                    </div><br>
                    <div>
                    ...
                    <div>
                        <input type="text" name="no_hp" class="form-control"  placeholder="Masukkan nomor telepon" required  autocomplete="off">
                    </div><br>
                        ...
                        if (tambahKepsek($_POST) > 0) {
                            echo "
                                <script>
                                    ...
                                    document.location.href = 'data-kepsek.php';
                                </script>";
                        } else {
                            echo "
                                <script>
